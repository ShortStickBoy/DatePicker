package com.sunzn.picker.library.config;
...
public class DefaultConfig {
    public static final Mode TYPE = Mode.ALL; // 全部类型
    ...
    public static final int TV_NORMAL_COLOR = 0xFF999999; // 默认文字颜色
    public static final int TV_SELECTOR_COLOR = 0XFF3262DE; // 选中文字颜色
