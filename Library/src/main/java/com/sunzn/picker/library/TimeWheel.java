...
import com.sunzn.picker.library.data.source.TimeRepository;
...
public class TimeWheel {
    ...
    private void initYearView() {
        ...
        mYearAdapter = new NumericWheelAdapter(mContext, minYear, maxYear, DateConstants.FORMAT, mScrollerConfig.mYear);
