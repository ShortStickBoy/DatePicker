...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    // 实例化参数, 传入数据
    private static DatePickerDialog newInstance(ScrollerConfig scrollerConfig) {
        DatePickerDialog dateScrollerDialog = new DatePickerDialog();
    ...
    public static class Builder {
        ...
        public Builder setType(Mode type) {
